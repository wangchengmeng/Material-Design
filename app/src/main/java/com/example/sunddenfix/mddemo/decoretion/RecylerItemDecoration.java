package com.example.sunddenfix.mddemo.decoretion;
 ...
 * @更新时间
 */
public class RecylerItemDecoration extends RecyclerView.ItemDecoration {
    private List<CityModel> mDatas;
    private Paint           mPaint;
    private Rect            mBounds;//用于存放测量文字Rect

    private int mTitleHeight;//title的高
    private static int COLOR_TITLE_BG   = Color.parseColor("#FFaaaaaa");
    private static int COLOR_TITLE_FONT = Color.parseColor("#FF000000");
    private static int mTitleFontSize;//title字体大小


    public RecylerItemDecoration(Context context, List<CityModel> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
